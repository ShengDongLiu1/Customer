		...
		loadMenu : function() {
			var data = [
					...
					},
					{
						...
						"F_FullName" : "潜在客户",
						"F_Icon" : "fa fa-book",
						"F_UrlAddress" : "/Customer/customer/queryState.do?page=1&state=1",
					},
					{
						"F_ModuleId" : "zhengshi",
						"F_ParentId" : "2",
						"F_FullName" : "正式客户",
						"F_Icon" : "fa fa-book",
						"F_UrlAddress" : "/Customer/customer/queryState.do?page=1&state=2",
					},
					{
						"F_ModuleId" : "fangqi",
						"F_ParentId" : "2",
						"F_FullName" : "放弃客户",
						"F_Icon" : "fa fa-book",
						"F_UrlAddress" : "/Customer/customer/queryState.do?page=1&state=3",
					},
					{
						"F_ModuleId" : "qianyue",
						"F_ParentId" : "2",
						"F_FullName" : "签约客户",
						"F_Icon" : "fa fa-book",
						"F_UrlAddress" : "/Customer/customer/queryState.do?page=1&state=4",
					},
					{
						"F_ModuleId" : "guanli",
						"F_ParentId" : "2",
					...
					},
					{
						...
						"F_FullName" : "营销机会管理",
						"F_Icon" : "fa fa-book",
						"F_UrlAddress" : "/Customer/marketing/queryAll.do?page=1",
					},
					{
						"F_ModuleId" : "kehukaifa",
						"F_ParentId" : "3",
						"F_FullName" : "客户开发计划管理",
						"F_Icon" : "fa fa-book",
