...
<body>
	<div class="row-fluid">
		<div class="span12" style="margin-top: 80px;">
			<form class="form-horizontal" action="<%=path %>/track/add.do" method="post">
				<div style='float: left;'>
					<div class="control-group">
						<div class="controls">
							<input type="hidden" style="height: 40px; width: 200px;" name="kid"
								 value="${customer.kid} " />
						</div>
					</div>
					<div class="control-group">
						<div class="controls">
							<input type="hidden" style="height: 40px; width: 200px;" name="uid"
								 value="${user.userid} " />
						</div>
					</div>
					...
					<div class="control-group" style="margin-left: 150px; margin-top: 30px;">
						...
						<div class="controls">
							<textarea style="height: 100px; width: 300px;" name="measure"></textarea>
						</div>
					</div>
					<div class="control-group" style="margin-left: 150px; margin-top: 30px;">
