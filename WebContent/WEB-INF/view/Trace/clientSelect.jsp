...
<body>
	<div >
		...
		<div class="span12"  style="float: left; margin-top: 10px; ">
			<div>
			<form class="form-horizontal" action="<%=path %>/track/queryAll.do?page=1" method="post">
				<div>
		...
		<div class="row-fluid">
			<div class="span12">
				<div class="pagination">
					<ul>
						<li><a href="<%=path %>/track/queryState.do?page=${lists.pageNo - 1}&state=${requestScope.state}">上一页</a></li>
						<li><a href="<%=path %>/track/queryState.do?page=${lists.pageNo + 1}&state=${requestScope.state}">下一页</a></li>
					</ul>
				</div>
			</div>
		</div>
