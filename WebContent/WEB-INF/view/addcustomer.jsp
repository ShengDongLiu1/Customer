...
<body>
	<div class="row-fluid">
		<div class="span12" style="margin-top: 80px;">
			<form name="form1" class="form-horizontal" action="<%=path %>/customer/addqr.do" method="post">
				<div style='float: left;'>
					...
					<div class="control-group">
						...
						<div class="controls">
							 <select id="usertype" name="combackdrop" style="height: 40px; width: 300px;">
				...
				<div class="control-group" style="margin-left: 300px; margin-top: 40px;"> 
						<div class="controls">
							<button type="submit" class="btn" style="height: 40px; width: 150px;" onclick="return addcustomer()">确认</button>
						</div>
				</div>
			</form>
		</div>
