...
<body>
	<div class="row-fluid">
		<div class="span12" style="margin-top: 80px;">
			<form class="form-horizontal" action="<%=path %>/product/updapr.do" >
				<div style='float: left;'>
					<div class="control-group">
						<div class="controls">
							<input type="hidden" style="height: 40px; width: 300px;" name="pid"
								 value="${product.pid} " />
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" style="height: 40px; width: 300px;"
								name="pname" value="${product.pname}" placeholder="产品名称" />
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">产品编号:</label>
						<div class="controls">
							<input type="text" value="${product.pnumber}" style="height: 40px; width: 300px;"
								name="pnumber" readonly="readonly" placeholder="产品编号" />
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">产品价格:</label>
						<div class="controls">
							<input type="text" value="${product.pprice}" style="height: 40px; width: 300px;"
				...
				<div style="float: left;">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" value="${product.pstock}" style="height: 40px; width: 300px;"
					...
					<div class="control-group">
						...
						<div class="controls">
							 <select id="ptype" name="ptype" style="height: 40px; width: 300px;">
