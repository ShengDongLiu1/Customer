...
public class DevelopmentController {
	...
	public String queyById1(@RequestParam(value = "id") Integer id, HttpServletRequest request,
	...
	public String addMarketing(@RequestParam(value = "id") Integer id, Development development,
	...
	public String list2(@RequestParam(value = "page", required = false) int page, Marketing marketing,
	...
	public String delete(@RequestParam(value = "page", required = false) int page,
			@RequestParam(value = "id", required = false) String kid, HttpServletResponse response,
